...
MODEL_CLASSES = {
    ...
    "rem": (RemBertConfig, RemBertForSequenceClassification, RemBertTokenizer)
}
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    if (args.local_rank == -1 and args.evaluate_during_training):
                        results = evaluate(args, model, tokenizer, split=args.train_split, language=args.train_language,
                                           lang2id=lang2id)
...
def main():
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        for checkpoint in checkpoints:
            ...
            model.to(args.device)
            result = evaluate(args, model, tokenizer, split='dev', language=args.train_language, lang2id=lang2id,
                              prefix=prefix)
            if result['acc'] > best_score:
    ...
    if args.do_predict and args.local_rank in [-1, 0]:
        ...
        with open(output_predict_file, 'a') as writer:
            ...
            for language in args.predict_languages.split(','):
                ...
                result = evaluate(args, model, tokenizer, split=args.test_split, language=language, lang2id=lang2id,
